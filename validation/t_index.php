...
<form id="myform" action="t_result.php" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable">
  ...
  <tr>
    <td width="22%" align="right">QQ号：</td>
    <td><input type="text" name="qq" id="qq" class="input required" />
    <p></p></td>
  </tr>
  <tr>
    <td width="22%" align="right">微信号：</td>
    <td><input type="text" name="weixin" id="weixin" class="input required" />
    <p>用户名为3-16个字符，可以为数字、字母、下划线以及中文</p></td>
  </tr>
  <tr>
